...
## Justificativa
- Implementação versátil da ALU suportando operações lógicas e aritméticas comuns.
- Uso de enumeração para operações melhora a legibilidade e manutenção do código.
